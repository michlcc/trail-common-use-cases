/**
 *  Padrão de design em massa em ação: exemplo de obtenção de registros relacionados 
 * (Fonte: https://trailhead.salesforce.com/content/learn/modules/apex_triggers/apex_triggers_bulk)
 * 
 */
